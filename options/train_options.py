...
class TrainOptions:
	...
	def initialize(self):
		...
		self.parser.add_argument('--encoder_type', default='BackboneEncoderUsingLastLayerIntoWPlus', type=str, help='Which encoder to use')
		...
		self.parser.add_argument('--output_size', default=64, type=int, help='Output size of generator')
		...
		self.parser.add_argument('--lr_encoder', default=0.00001, type=float, help='Optimizer learning rate encoder')
		self.parser.add_argument('--lr_decoder', default=0.000001, type=float, help='Optimizer learning rate decoder')
		...
		self.parser.add_argument('--val_interval', default=-1, type=int, help='Validation interval')
